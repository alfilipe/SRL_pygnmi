...
# Own modules
from .create_gnmi_path import gnmi_path_generator, gnmi_path_degenerator
from .create_gnmi_extension import get_gnmi_extension
#from .tools import diff_openconfig
...
class gNMIclient(object):
    ...
    def get(
        ...
        try:
            ...
            debug_gnmi_msg(self.__debug, gnmi_message_request, "gNMI request")
            #logger.info(gnmi_message_request)
